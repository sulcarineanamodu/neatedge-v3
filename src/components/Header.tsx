      ...
      <nav className="max-w-container mx-auto px-md py-3 flex justify-between items-center">
        ...
        <div className="flex-shrink-0">
          {logoSrc ? (
            ...
            <a href="/" className="text-xl font-bold text-white hover:text-brand-gold transition-colors">
              Neatedge
            </a>
          )}
        </div>
      ...
      {isMenuOpen && (
        ...
        >
          <div className="px-md py-4 space-y-2">
            ...
            <a
              href="/contact?enquiry=estimate"
              className="block w-full mt-4 px-5 py-2 bg-brand-gold text-brand-navy font-semibold rounded-base hover:bg-yellow-400 transition-colors duration-standard text-center focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-500"
            >
              Get an Estimate
            </a>
          </div>
